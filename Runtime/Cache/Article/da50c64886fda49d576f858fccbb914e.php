...
<script type="text/javascript">
    ...
    <div class="col-xs-10">
        <link rel="stylesheet" type="text/css" href="/wangzhan/Public/libs/cui/css/cui.extend.min.css">
<style type="text/css">
    .builder {
        background: #fff;
    }
...
<div class="builder builder-form-box panel-body">
    ...
    <div class="form-group item_<?php echo ($form["name"]); ?> <?php echo ($form["extra_class"]); ?>">
            ...
            <script type="text/javascript">
                $(function(){
                    var uploader_<?php echo ($group_k); ?>_upload_<?php echo ($k); ?> = WebUploader.create({
                        ...
                        swf: '/wangzhan/Public/libs/cui/swf/uploader.swf',                                               // swf文件路径
        ...
        <div class="right">
            ...
            <script type="text/javascript" src="/wangzhan/Public/libs/kindeditor/kindeditor-min.js" charset="utf-8"></script>
            <script type="text/javascript">
                $(function(){
                    KindEditor.ready(function(K) {
                        kindeditor_<?php echo ($k); ?> = K.create('#<?php echo ($group_k); ?>_kindeditor_<?php echo ($k); ?>', {
                            ...
                            filePostName : 'file',
                            cssPath : [
                                '/wangzhan/Public/libs/cui/css/cui.min.css',
                                '/wangzhan/Public/libs/kindeditor/plugins/code/prettify.css'
                            ],
                            width : '100%',
                            height : '500px',
                            resizeType: 1,
        ...
        <div class="right">
            ...
            <link rel="stylesheet" type="text/css" href="/wangzhan/Public/libs/editormd/css/editormd.min.css">
            <script type="text/javascript" src="/wangzhan/Public/libs/editormd/js/editormd.min.js"></script>
            ...
            <script type="text/javascript">
                ...
                var editormd_<?php echo ($group_k); ?>_markdown_<?php echo ($k); ?>_content = $('#default_<?php echo ($group_k); ?>_markdown_<?php echo ($k); ?>').text();
                    var editormd_<?php echo ($group_k); ?>_markdown_<?php echo ($k); ?> = editormd({
                            ...
                            path            : '/wangzhan/Public/libs/editormd/lib/',
                            pluginPath      : '/wangzhan/Public/libs/editormd/plugins/',
        ...
        <div class="right">
            ...
            <link rel="stylesheet" type="text/css" href="/wangzhan/Public/libs/jquery_tokeninput/css/token-input.css">
            <script type="text/javascript" src="/wangzhan/Public/libs/jquery_tokeninput/js/jquery.tokeninput.min.js" charset="utf-8"></script>
            <script type="text/javascript">
                $(function(){
                    //标签自动完成
...
<script type="text/javascript" src="/wangzhan/Public/libs/cui/js/cui.extend.min.js"></script>
<script type="text/javascript">
    $(function() {
        if (!$('.builder')) {
            return false;
