    ...
    i.prototype.slide = function(e, o) {
        ...
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            function() {
                ...
                0)
            }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (n.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger(p)),
            a && this.cycle(),
            this
        }
    };
...
function(t) {
    "use strict";
    t(document).delegate(".ajax-get", "click",
    function() {
        var e, i = this;
        return t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?") ? !1 : (((e = t(this).attr("href")) || (e = t(this).attr("url"))) && (t(this).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), t.get(e).success(function(e) {
            if (1 == e.status) {
                ...
                t.alertMessager(o, "success"),
                setTimeout(function() {
                    return t(i).removeClass("disabled").prop("disabled", !1),
                    t(i).hasClass("no-refresh") ? !1 : void(e.url && !t(i).hasClass("no-forward") ? location.href = e.url: location.reload())
                },
                2e3)
            } else 1 == e.login ? t("#login-modal").modal() : t.alertMessager(e.info, "danger"),
            setTimeout(function() {
...
function(t) {
    ...
    t.alertMessager = function(e, i, o) {
        i = i ? i: "danger";
        var n = '<div style="width:380px;height:auto;margin:0 auto;max-width: 80%;top:52px;left:0;right:0;z-index:99999;"class="messager navbar-fixed-top border-none alert alert-' + i + '"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>' + e + "</div>";
        t(".messager").remove(),
        t("body").prepend(n),
        setTimeout(function() {
            t(".messager").remove()
...
function(t) {
    ...
    function e(e) {
        return this.each(function() {
            ...
            s = t.extend({},
            i.DEFAULTS, o.data(), "object" == typeof e && e);
            n || o.data("bs.image-grid", n = new i(this, s)),
    ...
    i.prototype.processImages = function() {
        ...
        this.images.each(function(i) {
            ...
            e.row > e.albumWidth && e.elements.length && (e.resizeRow(e.row - e.options.padding), e.row = 0, e.elements = [], e.rownum += 1),
            e.images.length - 1 == i && e.elements.length && (e.resizeRow(e.row), e.row = 0, e.elements = [], e.rownum += 1)
        })
    },
    i.prototype.resizeRow = function(e) {
        for (var i = this.options.padding * (this.elements.length - 1), o = this.albumWidth - i, n = o / (e - i), s = i, a = (e < this.albumWidth, 0); a < this.elements.length; a++) {
            ...
            s += l,
            !d && s < this.albumWidth && (l += this.albumWidth - s),
            l--;
...
function(t) {
    ...
    r = t.cookie = function(n, a, l) {
        ...
        for (var c = n ? void 0 : {},
        p = document.cookie ? document.cookie.split("; ") : [], f = 0, u = p.length; u > f; f++) {
            var g = p[f].split("="),
            m = i(g.shift()),
            v = g.join("=");
            if (n && n === m) {
...
function(t, e, i, o) {
    ...
    t.fn.lazyload = function(s) {
        function a() {
            ...
            l.each(function() {
                var i = t(this);
                if (!h.skip_invisible || i.is(":visible")) if (t.abovethetop(this, h) || t.leftofbegin(this, h));
        ...
        return s && (o !== s.failurelimit && (s.failure_limit = s.failurelimit, delete s.failurelimit), o !== s.effectspeed && (s.effect_speed = s.effectspeed, delete s.effectspeed), t.extend(h, s)),
        r = h.container === o || h.container === e ? n: t(h.container),
        0 === h.event.indexOf("scroll") && r.bind(h.event,
        function() {
            return a()
        }),
        this.each(function() {
    ...
    t.belowthefold = function(i, s) {
        var a;
        return a = s.container === o || s.container === e ? (e.innerHeight ? e.innerHeight: n.height()) + n.scrollTop() : t(s.container).offset().top + t(s.container).height(),
        a <= t(i).offset().top - s.threshold
    },
    t.rightoffold = function(i, s) {
        var a;
        return a = s.container === o || s.container === e ? n.width() + n.scrollLeft() : t(s.container).offset().left + t(s.container).width(),
        a <= t(i).offset().left - s.threshold
    },
    t.abovethetop = function(i, s) {
        var a;
        return a = s.container === o || s.container === e ? n.scrollTop() : t(s.container).offset().top,
        a >= t(i).offset().top + s.threshold + t(i).height()
    },
    t.leftofbegin = function(i, s) {
        var a;
        return a = s.container === o || s.container === e ? n.scrollLeft() : t(s.container).offset().left,
        a >= t(i).offset().left + s.threshold + t(i).width()
    },
...
function(t) {
    "use strict";
    t("body").delegate(".nav-close .close", "click",
    function() {
...
function(t) {
    ...
    e || t("input.form-control").show(function() {
     ...
     //   t(this).val(""),  zss 	2016
       ...
       // "" == t(this).val() && t(this).val(t(this).attr("placeholder"))	zss 	2016
    })
} (jQuery),
+
function(t) {
    ...
    i.prototype._calculateZoom = function() {
        ...
        r = e / o,
        l = a / s;
        a > e && s > o ? this._imgScaleFactor = n: l > r ? this._imgScaleFactor = s / o * n: this._imgScaleFactor = a / e * n
    },
    i.prototype._triggerAnimation = function() {
        ...
        this._translateY = o - s,
        this._translateX = n - a;
